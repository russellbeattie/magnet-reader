...
<div class="sourceItems"></div>

<div class="more"><i class="icon-refresh"></i></div>
  ...
  <%
    ...
    <div class="sourceItem item <%=expandClass%> newFolder-<%=newFolder%>" data-id="<%=id%>" data-color="<%=folderColor%>" data-newFolder="<%=newFolder%>">
		...
		<div class="sourceItemOptions">
		    ...
		    <span class="starItem button" data-starred="<%=starred%>" title="Star">
		    	<% if(starred) { %>
					<i class="icon-star"></i>
				<% } else { %>
		...
		<div class="sourceTitle" data-source-id="<%=sourcesId%>"> 
